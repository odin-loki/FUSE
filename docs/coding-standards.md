...
- Host: ISO C++23 for all code under `Source/FUSE/` and product tools under `Tools/FUSE/`. Vendored third-party trees under `vendor/` keep their upstream dialect (DXVK stays C++17).
