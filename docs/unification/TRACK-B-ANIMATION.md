...
**Status:** B7.1 deepen — `PoseSoA` pose buffers, hierarchy-aware clip evaluate, layered blend weights  
...
| `FABRIKChain` / two-bone IK | `Animation/include/fuse/animation/ik_solver.hpp` | CPU IK stubs |
