...
| **Deps** | WP-06 |
| **Status** | ✅ Prestarter §10 gates closed; post-gate ore through U5 wave 16 (inotify picker hot-reload, bone motion sync, selective CUDA writeback, Path/Timer gates, bind pose bridge) — [U5-MODULES.md](./U5-MODULES.md) |
