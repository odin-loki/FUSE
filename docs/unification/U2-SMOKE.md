...
| Engine `.cpp` probe | ✅ **opt-in** `-DFUSE_T3D_LEGACY_ENGINE_PROBE=ON` | Batch 1–7 (see table); batch 8: `core/color.cpp`, `core/dataChunker.cpp` + console/engineAPI shadows, `color_cpp_prelude.h`, `color_real_wrapper.h`, `color_probe_smoke.cpp` |
