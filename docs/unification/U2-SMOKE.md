...
| Engine `.cpp` probe | ✅ **opt-in** `-DFUSE_T3D_LEGACY_ENGINE_PROBE=ON` | Batch 1–11 (see table); batch 12: bitStream Huffman/class-id smoke, `uuid_probe_stub`, deepen `gbitmap_probe_stub` RGB8/extrudeMipLevels |
