#version 460
// WP-9.3 test raster (fuse_rp_dgc): the WP-1.3 cull_draw vertex stage. gl_InstanceIndex includes
// firstInstance (= the instance slot the cull wrote); the transform comes from the scene through BDA.
// GLSL twin of dgc_draw_vs.slang.
