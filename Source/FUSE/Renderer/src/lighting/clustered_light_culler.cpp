...
void ClusterLightGridLayout::rebuildLightGrid(ClusterGridSoA& grid,
                                              u32 clusterCount,
...
void ClusteredLightCuller::rebuildLightGrid() {
    ...
    ClusterLightGridLayout::rebuildLightGrid(m_gridSoA, m_desc.clusterCount(), m_pendingClusterLights);
}
