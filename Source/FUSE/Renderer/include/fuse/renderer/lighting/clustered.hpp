...
/// Early-out when the grid is inaccessible or no clusters hold assigned lights.
bool shouldSkipClusterLighting(const ClusterGridSoA& grid, const ClusterDesc& desc, u32 clusterCount);
} // namespace cluster_util
