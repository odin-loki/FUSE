...
/// True when a curve can be applied (disabled curves always pass) (B5.10 deepen).
...
/// True when mid-grey curve output stays in display range (B5.10 deepen).
bool tonemap_curve_mid_grey_in_display_range(const TonemapCurveParams& params, f32 mid_grey = 0.18f,
                                             f32 epsilon = 1e-4f);
