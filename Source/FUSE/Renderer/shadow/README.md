...
| Header | Role |
|--------|------|
| `shadow/csm.hpp` | `CascadedShadowMapDesc`, `CascadedShadowMapData`, cascade split/range helpers, `CascadeLightSpaceLayout` AABB stubs |
...
`fuse_shadow_system` covers cascade split/range math, light-space AABB fitting, 2×2 atlas layout, directional shadow allocation/update, and render-graph pass registration.
