...
struct ChromeTraceExportPreflight {
    ...
    bool hasFlowEventImbalances() const { return hasUnpairedAsyncFlowEvents || hasOpenAsyncFlows; }
...
bool hasUnpairedAsyncFlowEvents();
...
u32 countFlowEventsByPhase(u32 flowId, EventPhase phase);
