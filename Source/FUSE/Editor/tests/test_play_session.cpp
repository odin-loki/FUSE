...
void testPlaySessionVariableTickPreflightAndRemainder() {
    ...
    expectTrue(!zeroDtPreflight.skipped, "variable preflight allows zero dt while playing");
    expectTrue(zeroDtPreflight.wouldSimulate, "variable preflight would simulate zero dt");
    expectTrue(!zeroDtPreflight.wouldAdvanceAccumulator,
               "variable preflight does not advance accumulator for zero dt");
