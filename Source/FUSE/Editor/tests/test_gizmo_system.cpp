...
void testBeginInteractionPreflight() {
    ...
    expectTrue(degradedSnap.snapDegraded(), "begin interaction snapDegraded helper marks degraded snap");
...
void testPickRejectReasonGuards() {
    ...
    fuse::editor::GizmoRay nanRay = rayAlongX();
    nanRay.origin.y = std::numeric_limits<fuse::f32>::quiet_NaN();
    fuse::editor::GizmoPickRejectReason nanReason = fuse::editor::GizmoPickRejectReason::None;
    expectTrue(!fuse::editor::tryPreflightPick(nanRay, transform, fuse::editor::GizmoMode::Translate,
                                              fuse::editor::GizmoSpace::World,
                                              fuse::editor::GizmoSystem::kAxisLength,
                                              fuse::editor::GizmoSystem::kPickRadius, nanReason),
               "tryPreflightPick rejects non-finite ray");
    expectTrue(nanReason == fuse::editor::GizmoPickRejectReason::NonFiniteRay,
    ...
    expectTrue(nanReason == fuse::editor::GizmoPickRejectReason::NonFiniteHit,
               "non-finite hit reject reason is NonFiniteHit");
    fuse::editor::GizmoHitTest invalidDims{};
    invalidDims.viewportWidth = -100.f;
    invalidDims.viewportHeight = 100.f;
    invalidDims.screenX = 10.f;
    invalidDims.screenY = 50.f;
    ...
    expectTrue(screenReason == fuse::editor::GizmoPickRejectReason::InvalidDimensions,
               "invalid dimensions pick reject reason is InvalidDimensions");
    expectTrue(std::strcmp(fuse::editor::gizmoPickRejectReasonLabel(
                   fuse::editor::GizmoPickRejectReason::InvalidDimensions),
               "InvalidDimensions") == 0,
               "pick reject reason label for InvalidDimensions");
...
void testBeginDragRejectReasonGuards() {
    ...
    expectTrue(reason == fuse::editor::GizmoBeginDragRejectReason::InvalidDimensions,
               "invalid dimensions begin reject reason is InvalidDimensions");
...
void testUpdateDragRejectReasonGuards() {
    ...
    expectTrue(reason == fuse::editor::GizmoUpdateDragRejectReason::InvalidDimensions,
               "invalid dimensions update reject reason is InvalidDimensions");
    expectTrue(std::strcmp(fuse::editor::gizmoUpdateDragRejectReasonLabel(
                   fuse::editor::GizmoUpdateDragRejectReason::InvalidDimensions),
               "InvalidDimensions") == 0,
               "update reject reason label for InvalidDimensions");
...
void testNonFinitePickRejectReasonGuards() {
    ...
    expectTrue(!fuse::editor::preflightPickReady(nanHit, fuse::editor::GizmoMode::Translate, &reason),
               ...
               "shouldSkipPick true for non-finite screen hit");
...
void testNonFiniteBeginDragRejectReasonGuards() {
    ...
    expectTrue(fuse::editor::shouldSkipBeginDrag(nanHit, fuse::editor::GizmoMode::Translate),
               "shouldSkipBeginDrag true for non-finite hit");
...
void testNonFiniteRejectReasonGuards() {
    ...
    infRay.direction.z = std::numeric_limits<fuse::f32>::infinity();
                   infRay, transform, fuse::editor::GizmoMode::Translate,
               "non-finite begin ray reject reason is NonFiniteRay");
...
void testInvalidDimensionsRejectReasonGuards() {
    ...
    expectTrue(!fuse::editor::tryPreflightBeginDrag(hit, fuse::editor::GizmoMode::Translate,
               "tryPreflightBeginDrag rejects invalid viewport dimensions");
...
void testSnapDragRejectReasonGuards() {
    ...
    const fuse::editor::SnapDragPreflight degradedPreflight =
        fuse::editor::preflightSnapDrag(0.37f, fuse::editor::GizmoMode::Translate, snap);
    expectTrue(degradedPreflight.isDegraded(),
               "snap-drag preflight isDegraded when snap enabled with invalid step");
    expectTrue(fuse::editor::isSnapDegraded(fuse::editor::GizmoMode::Translate, snap),
               "isSnapDegraded matches snap-drag degraded preflight");
    expectTrue(fuse::editor::classifySnapDragReject(degradedPreflight) ==
                   fuse::editor::GizmoSnapDragRejectReason::InvalidStep,
               "classifySnapDragReject maps invalidStep flag");
    expectTrue(!fuse::editor::tryPreflightSnapDrag(0.37f, fuse::editor::GizmoMode::Translate, snap,
...
void testInteractionRejectReasonGuards() {
    ...
    expectTrue(fuse::editor::preflightBeginDragInteractionReady(hit, fuse::editor::GizmoMode::Translate,
                                                                snap) ==
                   fuse::editor::canBeginDragInteraction(hit, fuse::editor::GizmoMode::Translate,
                                                           snap),
    ...
    expectTrue(beginReason == fuse::editor::GizmoBeginDragRejectReason::NonFiniteHit,
               "non-finite begin interaction reject reason is NonFiniteHit");
    expectTrue(fuse::editor::shouldSkipBeginDragInteraction(hit, fuse::editor::GizmoMode::Translate,
                                                          snap),
               "shouldSkipBeginDragInteraction true for non-finite hit");
    ...
    expectTrue(updateReason == fuse::editor::GizmoUpdateDragRejectReason::None,
               "valid update interaction reject reason is None");
                                                                 snap) ==
                   fuse::editor::canUpdateDragInteraction(hit, true, fuse::editor::GizmoAxis::X,
                                                          fuse::editor::GizmoMode::Translate, snap),
    ...
    expectTrue(updateReason == fuse::editor::GizmoUpdateDragRejectReason::NonFiniteHit,
               "non-finite update interaction reject reason is NonFiniteHit");
    ...
    expectTrue(fuse::editor::preflightEndDragInteractionReady(true, fuse::editor::GizmoAxis::X,
                                                              fuse::editor::GizmoMode::Translate,
                                                              snap) ==
                   fuse::editor::canEndDragInteraction(true, fuse::editor::GizmoAxis::X,
                                                       fuse::editor::GizmoMode::Translate, snap),
...
void testNonFinitePickRejectReasonGuards() {
    ...
    expectTrue(!fuse::editor::tryPreflightBeginDrag(
                   nanRay, transform, fuse::editor::GizmoMode::Translate,
                   fuse::editor::GizmoSpace::World, fuse::editor::GizmoSystem::kAxisLength,
                   fuse::editor::GizmoSystem::kPickRadius, beginRayReason),
               "tryPreflightBeginDrag rejects non-finite ray");
    ...
    expectTrue(fuse::editor::preflightSnapDragReady(0.25f, fuse::editor::GizmoMode::Translate,
                                                    snap) == fuse::editor::canSnapDragDelta(
                                                                 0.25f, fuse::editor::GizmoMode::Translate,
                                                                 snap),
...
void testNonFiniteBeginDragRejectReasonGuards() {
    ...
    fuse::editor::GizmoRay emptyNanRay = rayAlongX();
    emptyNanRay.direction.z = std::numeric_limits<fuse::f32>::infinity();
                   emptyNanRay, transform, fuse::editor::GizmoMode::Translate,
...
void testNonFiniteUpdateDragRejectReasonGuards() {
    ...
    expectTrue(gizmo.shouldSkipUpdateDrag(nanHit), "gizmo shouldSkipUpdateDrag true for non-finite hit");
    ...
    expectTrue(fuse::editor::tryPreflightSnapDrag(0.25f, fuse::editor::GizmoMode::Translate, snap,
    expectTrue(!fuse::editor::shouldSkipSnapDrag(0.25f, fuse::editor::GizmoMode::Translate, snap),
    ...
    expectTrue(fuse::editor::shouldSkipSnapDrag(0.37f, fuse::editor::GizmoMode::Translate, snap),
               ...
               "shouldSkipSnapDrag true for invalid step");
...
void testDragInteractionReadyHelpers() {


               "preflightBeginDragInteractionReady accepts valid hit");

    expectTrue(!fuse::editor::preflightBeginDragInteractionReady(hit, fuse::editor::GizmoMode::Translate,
               "preflightBeginDragInteractionReady rejects non-finite hit");
               "non-finite begin interaction reject reason is NonFiniteHit");

    expectTrue(fuse::editor::preflightUpdateDragInteractionReady(hit, true,
               "preflightUpdateDragInteractionReady accepts active drag");

               "preflightEndDragInteractionReady accepts active drag");
    ...
    expectTrue(fuse::editor::shouldSkipSnapDrag(0.37f, fuse::editor::GizmoMode::Translate, snap) ==
                   !fuse::editor::preflightSnapDragReady(0.37f, fuse::editor::GizmoMode::Translate,
...
void testInteractionRejectReasonGuards() {
    ...
    expectTrue(!fuse::editor::shouldSkipBeginInteraction(hit, fuse::editor::GizmoMode::Translate,
               "shouldSkipBeginInteraction false for valid hit");
    ...
    expectTrue(!fuse::editor::shouldSkipEndInteraction(true, fuse::editor::GizmoAxis::X,
               "shouldSkipEndInteraction false when dragging");
    ...
    expectTrue(!gizmo.shouldSkipEndInteraction(), "gizmo shouldSkipEndInteraction false during drag");
    expectTrue(gizmo.tryPreflightSnapDrag(0.25f, reason),
    expectTrue(!gizmo.shouldSkipSnapDrag(0.25f), "gizmo shouldSkipSnapDrag false for valid delta");

    hit = hitFromValidScreen();
    expectTrue(!gizmo.shouldSkipBeginDragInteraction(hit),
               "gizmo shouldSkipBeginDragInteraction false for valid hit");
    expectTrue(gizmo.tryPreflightEndDragInteraction(endReason),
               "gizmo tryPreflightEndDragInteraction accepts active drag");
               "gizmo shouldSkipEndDragInteraction false during drag");
void testBeginDragInteractionRejectReasonGuards() {
    ...
    expectTrue(!fuse::editor::tryPreflightBeginDragInteraction(emptyHit,
               ...
               "empty viewport interaction reject reason is EmptyHit");
    expectTrue(fuse::editor::shouldSkipBeginDragInteraction(emptyHit,
                                                            snap),
               "shouldSkipBeginDragInteraction true for empty viewport");
    ...
    expectTrue(!fuse::editor::preflightBeginDragInteractionReady(
                   emptyRay, transform, fuse::editor::GizmoMode::Translate,
                   fuse::editor::GizmoSpace::World, fuse::editor::GizmoSystem::kAxisLength,
                   fuse::editor::GizmoSystem::kPickRadius, snap, &reason),
...
void testUpdateDragInteractionRejectReasonGuards() {
    ...
    expectTrue(dragReason == fuse::editor::GizmoUpdateDragRejectReason::NotDragging,
               "inactive drag interaction reject reason is NotDragging");
    expectTrue(fuse::editor::shouldSkipUpdateDragInteraction(hit, false,
               "shouldSkipUpdateDragInteraction true when not dragging");
    ...
    expectTrue(gizmo.tryPreflightUpdateDragInteraction(hit, 0.37f, dragReason, snapDragReason),
               ...
               "finite delta interaction snap-drag reject reason is None");
    ...
    expectTrue(!gizmo.preflightUpdateDragInteractionSnapDragReady(
                   hit, std::numeric_limits<fuse::f32>::quiet_NaN(), &snapDragReason),
...
int main() {
    ...
    testDragInteractionReadyHelpers();
    testNonFinitePickRejectReasonGuards();
    testNonFiniteBeginDragRejectReasonGuards();
    testNonFiniteUpdateDragRejectReasonGuards();
