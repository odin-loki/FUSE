...
bool tryPreflightBeginDragInteraction(const GizmoRay& ray, const GizmoTransform& transform,
    ...
    return preflightBeginDragInteractionReady(ray, transform, mode, space, axisLength, pickRadius,
                                              settings, &reason, alreadyDragging);
}
...
bool preflightUpdateDragInteractionSnapDragReady(const GizmoHitTest& hit, bool dragging,
    ...
    return preflight.snapDragWillApply();
}
...
bool shouldSkipBeginInteraction(const GizmoHitTest& hit, GizmoMode mode,
                                const GizmoSnapSettings& settings, bool alreadyDragging) {
    return !preflightBeginInteractionReady(hit, mode, settings, nullptr, alreadyDragging);

bool shouldSkipBeginInteraction(const GizmoRay& ray, const GizmoTransform& transform,
                                GizmoMode mode, GizmoSpace space, f32 axisLength, f32 pickRadius,
    return !preflightBeginInteractionReady(ray, transform, mode, space, axisLength, pickRadius,
                                           settings, nullptr, alreadyDragging);
...
bool preflightUpdateInteractionReady(const GizmoHitTest& hit, bool dragging, GizmoAxis activeAxis,
    const UpdateInteractionPreflight preflight =
        preflightUpdateInteraction(hit, dragging, activeAxis, mode, settings);
...
bool shouldSkipUpdateInteraction(const GizmoHitTest& hit, bool dragging, GizmoAxis activeAxis,
                                 GizmoMode mode, const GizmoSnapSettings& settings) {
...
bool preflightEndInteractionReady(bool dragging, GizmoAxis activeAxis, GizmoMode mode,
    const EndInteractionPreflight preflight =
        preflightEndInteraction(dragging, activeAxis, mode, settings);
...
bool shouldSkipEndInteraction(bool dragging, GizmoAxis activeAxis, GizmoMode mode,
                              const GizmoSnapSettings& settings) {
...
bool shouldSkipUpdateDragInteraction(const GizmoHitTest& hit, bool dragging, GizmoAxis activeAxis,
    return !preflightUpdateDragInteractionReady(hit, dragging, activeAxis, mode, settings);
                                       ...
                                       GizmoMode mode, const GizmoSnapSettings& settings, f32 delta) {
    return !preflightUpdateDragInteractionReady(hit, dragging, activeAxis, mode, settings, delta);
...
bool GizmoSystem::shouldSkipBeginInteraction(const GizmoHitTest& hit) const {
    return fuse::editor::shouldSkipBeginInteraction(hit, m_mode, m_snap, m_dragging);

bool GizmoSystem::shouldSkipBeginInteraction(const GizmoRay& ray,
                                             const GizmoTransform& transform) const {
    return fuse::editor::shouldSkipBeginInteraction(ray, transform, m_mode, m_space, kAxisLength,
                                                      kPickRadius, m_snap, m_dragging);
...
bool GizmoSystem::shouldSkipUpdateInteraction(const GizmoHitTest& hit) const {
    return fuse::editor::shouldSkipUpdateInteraction(hit, m_dragging, m_activeAxis, m_mode, m_snap);
...
bool GizmoSystem::shouldSkipEndInteraction() const {
    return fuse::editor::shouldSkipEndInteraction(m_dragging, m_activeAxis, m_mode, m_snap);
...
bool GizmoSystem::shouldSkipBeginDragInteraction(const GizmoRay& ray,
    return fuse::editor::shouldSkipBeginDragInteraction(
        ray, transform, m_mode, m_space, kAxisLength, kPickRadius, m_snap, m_dragging);
...
bool GizmoSystem::tryPreflightUpdateDragInteraction(const GizmoHitTest& hit, f32 delta,
    ...
    GizmoSnapDragRejectReason* snapDragReason) const {
                                                            m_snap, delta, dragReason,
                                                            snapDragReason);


bool GizmoSystem::tryPreflightUpdateDragInteraction(
    const GizmoHitTest& hit, f32 delta, GizmoUpdateDragRejectReason& dragReason,
    GizmoSnapDragRejectReason& snapDragReason) const {
...
bool GizmoSystem::shouldSkipUpdateDragInteraction(const GizmoHitTest& hit, f32 delta) const {
                                                         m_snap, delta);
