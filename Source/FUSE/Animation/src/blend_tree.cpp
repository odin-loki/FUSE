...
bool AnimStateMachine::is_valid_outgoing_transition_edge(u32 from_state, u32 edge_index) const {
    return edge_index < outgoing_transition_count(from_state);
}

bool AnimStateMachine::is_valid_incoming_transition_edge(u32 to_state, u32 edge_index) const {
    return edge_index < incoming_transition_count(to_state);
}
