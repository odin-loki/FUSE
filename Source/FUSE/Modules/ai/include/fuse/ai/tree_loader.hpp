...
///   typeId [threshold=N] [flag=N] [loops=N] [scalar=N] [success=N] [fail=N] [abort=1] [require_board=1] [require_allies=1] [require_agent=1] [children=a,b] [hook=scriptName]
...
///   typeId [threshold=N] [flag=N] [loops=N] [scalar=N] [success=N] [fail=N] [abort=1] [require_board=1] [require_allies=1] [require_agent=1] [require_nonempty_board=1] [require_radius=1] [children=a,b] [hook=scriptName]
