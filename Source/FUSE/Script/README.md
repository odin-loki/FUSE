...
| `script_console_command_registry.hpp` | Named built-in/custom command registry with `lookup_kind`, prefix match, shadowing + sorted `help`/`list` |
