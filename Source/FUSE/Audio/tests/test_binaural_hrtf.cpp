...
void testHrtfPanPathRejectReasonGuards() {
    ...
    expectTrue(fuse::audio::try_preflight_spatial_hrtf_pan(true, empty, offset, spatial_reason),
               "try_preflight_spatial_hrtf_pan accepts enabled offset source");
    ...
    expectTrue(!fuse::audio::try_preflight_spatial_hrtf_pan(false, valid, offset, spatial_reason),
               "try_preflight_spatial_hrtf_pan rejects disabled HRTF");
    ...
    expectTrue(!fuse::audio::preflight_spatial_hrtf_pan_ready(true, valid, co_located,
                                                               &spatial_reason),
               "preflight_spatial_hrtf_pan_ready rejects co-located source");
    ...
    expectTrue(fuse::audio::try_preflight_hrtf_convolution(true, valid, offset, conv_reason),
               "try_preflight_hrtf_convolution accepts valid IR");
    ...
    expectTrue(!fuse::audio::try_preflight_hrtf_convolution(true, empty, offset, conv_reason),
               "try_preflight_hrtf_convolution rejects empty IR");
    ...
    const fuse::audio::HrtfIrStub malformed{samples, 0};
    expectTrue(!fuse::audio::preflight_hrtf_convolution_ready(true, malformed, offset, &conv_reason),
               "preflight_hrtf_convolution_ready rejects malformed IR");
    ...
    expectTrue(fuse::audio::try_preflight_spatial_hrtf_pan(true, offset, spatial_reason),
               "no-IR spatial preflight overload accepts enabled offset");
    expectTrue(spatial_reason == fuse::audio::HrtfPanPathRejectReason::None,
               "no-IR spatial preflight reject reason is None");
}
...
void testHrtfAttenuationCouplingRejectReasonGuards() {
    ...
    expectTrue(!fuse::audio::preflight_hrtf_attenuation_narrowing_ready(
               ...
               "preflight_hrtf_attenuation_narrowing_ready rejects unity attenuation");
...
void testHrtfBinauralRejectReasonGuards() {
    ...
    expectTrue(fuse::audio::try_preflight_hrtf_binaural_spatial(true, empty, offset, 0.2f, 0.3f,
                                                                reason),
               "try_preflight_hrtf_binaural_spatial accepts enabled stub path");
    expectTrue(reason == fuse::audio::HrtfBinauralRejectReason::None,
               "enabled stub spatial reject reason is None");
    ...
    expectTrue(!fuse::audio::preflight_hrtf_binaural_spatial_ready(true, valid, co_located, 0.1f,
                                                                   0.1f, {}, {}, &reason),
               "preflight_hrtf_binaural_spatial_ready rejects co-located source");
    ...
    expectTrue(fuse::audio::preflight_hrtf_binaural_spatial_ready(true, offset, 0.25f, 0.35f),
               "no-IR binaural spatial preflight overload accepts enabled offset");
}
...
void testRejectReasonMirrorsExistingPreflights() {
    ...
    expectTrue(fuse::audio::preflight_spatial_hrtf_pan_ready(true, empty, offset)
                   == fuse::audio::can_apply_spatial_hrtf_pan(
                          fuse::audio::preflight_hrtf_pan_path(true, empty, offset)),
               "preflight_spatial_hrtf_pan_ready mirrors can_apply_spatial_hrtf_pan");
    ...
    expectTrue(
        fuse::audio::preflight_hrtf_attenuation_narrowing_ready(
            fuse::audio::HrtfPanPath::IldItdStub, 0.2f, 0.3f)
