...
// --- deepen additive from deepen-b79-cooker-hash-should-skip-2a58 ---
               "preflight should_skip agrees with mesh import helper");
               "should_skip allows valid source-only cache key fold");
