...
bool AssetCooker::would_invalidate_stale_dependency_hashes(const CookManifest& manifest) const {
    ...
    return m_cache.should_skip_prune_all();
    ...
    return !would_invalidate_stale_dependencies(manifest);
...
bool AssetCooker::should_skip_reconcile_invalidation(const CookManifest& manifest,
    ...
    return estimate_prune_reconcile().should_skip_prune();

    return estimate_reconcile_invalidation(manifest).should_skip_reconcile();
