...
const std::vector<Phase4TestCase> kCatalog = {
    ...
    {"solver.island_partition",
     ...
     true,
     false},
    {"solver.iteration_convergence",
     "Rest-length spring converges under N iterations; residual decreases; multi-island independence",
     Phase4TestCategory::Solver,
     true,
     false},
    {"solver.warm_start_lambda",
     "Distance/contact lambda warm-start seeds persist across frames and substeps",
     Phase4TestCategory::Solver,
     true,
     false},
    {"solver.island_solve_job",
     "extract_island / solve_island_job / per_pair_delta_application / frame_lambda_warm_start stubs",
     Phase4TestCategory::Solver,
     true,
     false},
