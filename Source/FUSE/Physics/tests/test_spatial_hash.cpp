...
void testPairBufferInvalidateSlotRejectReasonGuards() {
    ...
    expectEq(static_cast<fuse::u32>(
             ...
             "empty buffer reports EmptyBuffer invalidate-slot reject reason");
    expectTrue(fuse::physics::broadphase::canSkipPairBufferInvalidateSlot(buffer, 0u),
               "canSkipPairBufferInvalidateSlot on empty buffer");
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferInvalidateSlot(buffer, 0u),
    ...
    const fuse::u32 activeBefore = buffer.countValidSlots();
    buffer.invalidateSlot(2u);
    expectEq(buffer.countValidSlots(), activeBefore, "invalidateSlot ignores out-of-range slot via preflight gate");
    buffer.invalidateSlot(1u);
    expectEq(buffer.countValidSlots(), activeBefore, "invalidateSlot ignores already-invalid slot via preflight gate");
    buffer.invalidateSlot(0u);
    expectEq(buffer.countValidSlots(), activeBefore - 1u, "invalidateSlot clears valid slot via preflight gate");
}
...
void testPairBufferInvalidateSlotRejectReasonGuards() {
    ...
    const fuse::physics::broadphase::PairBufferInvalidateSlotPreflight preflight =
        fuse::physics::broadphase::preflightPairBufferInvalidateSlot(buffer, 1u);
    expectTrue(preflight.canInvalidate(), "invalidate preflight accepts remaining valid slot");
}
...
void testPairBufferSlotValidityBounds() {
    ...
    buffer.invalidateSlot(2u);
    expectTrue(buffer.slotIsValid(0u), "invalidateSlot ignores out-of-range slot via preflight");
    buffer.invalidateSlot(99u);
    expectTrue(buffer.slotIsValid(0u), "invalidateSlot ignores far out-of-range slot via preflight");
...
void testWouldSkipBroadphaseGuards() {
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipMergePairsIntoBuffer(emptyPairs, buffer) ==
                   fuse::physics::broadphase::canSkipMergePairsIntoBuffer(emptyPairs, buffer),
               "wouldSkipMergePairsIntoBuffer agrees with canSkipMergePairsIntoBuffer");

    const fuse::physics::broadphase::CellRange3 overBudgetRange = {{0, 0, 0}, {3, 3, 3}};
    expectTrue(fuse::physics::broadphase::wouldSkipCellOccupancyIteration(overBudgetRange, 7u),
               "wouldSkipCellOccupancyIteration true over budget");
    expectTrue(fuse::physics::broadphase::wouldSkipCellOccupancyIteration(overBudgetRange, 7u) ==
                   fuse::physics::broadphase::canSkipCellOccupancyIteration(overBudgetRange, 7u),
               "wouldSkipCellOccupancyIteration agrees with canSkipCellOccupancyIteration");
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipCellSpanClamp(withinRange, 4u),
               "wouldSkipCellSpanClamp true when span is within limit");
    expectTrue(fuse::physics::broadphase::wouldSkipCellSpanClamp(withinRange, 4u) ==
                   fuse::physics::broadphase::canSkipCellSpanClamp(withinRange, 4u),
               "wouldSkipCellSpanClamp agrees with canSkipCellSpanClamp");

    fuse::physics::broadphase::PairBufferSoA writeBuffer;
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferWriteSlot(writeBuffer, 0u, 1u, 1u) ==
                   fuse::physics::broadphase::canSkipPairBufferWriteSlot(writeBuffer, 0u, 1u, 1u),
               "wouldSkipPairBufferWriteSlot agrees with canSkipPairBufferWriteSlot");
}
...
void testCellCapacityRejectReasonAndPreflight() {
    ...
    expectEq(static_cast<fuse::u32>(
             ...
             static_cast<fuse::u32>(fuse::physics::broadphase::CellCapacityRejectReason::None),
             "within-limit range reports None cell-capacity reject reason");
    ...
    expectTrue(fuse::physics::broadphase::shouldRunCellCapacityCheck(validRange, 8u, 4u),
               "shouldRunCellCapacityCheck true for valid range");
    ...
    expectTrue(std::strcmp(fuse::physics::broadphase::cellCapacityRejectReasonName(
                           ...
                           "ExceedsSpan") == 0,
               "ExceedsSpan cell-capacity reject reason has stable label");
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipCellOccupancyIteration(planeRange, 4u) ==
                   fuse::physics::broadphase::canSkipCellOccupancyIteration(planeRange, 4u),
               "wouldSkipCellOccupancyIteration agrees with canSkipCellOccupancyIteration");
    expectTrue(fuse::physics::broadphase::wouldSkipCellSpanClamp(planeRange, 2u) ==
                   fuse::physics::broadphase::canSkipCellSpanClamp(planeRange, 2u),
               "wouldSkipCellSpanClamp agrees with canSkipCellSpanClamp");
}

void testRefineDedupeMergeWouldSkipHelpers() {
    fuse::physics::RigidBodySoA bodies;
    fuse::physics::CollisionShapeSoA shapes;
    fuse::physics::broadphase::PairBufferSoA buffer;
    ...
    expectTrue(!fuse::physics::broadphase::wouldSkipDedupeBroadphase(buffer),
               "wouldSkipDedupeBroadphase false for multiple pairs");
    expectTrue(fuse::physics::broadphase::wouldSkipMergePairsIntoBuffer(pairs, buffer) ==
                   !fuse::physics::broadphase::shouldRunMergePairsIntoBuffer(pairs, buffer),
...
void testWouldSkipBroadphaseGuardParity() {
    ...
    const fuse::physics::broadphase::CellRange3 validRange = {{0, 0, 0}, {1, 1, 1}};
    expectTrue(fuse::physics::broadphase::wouldSkipCellOccupancyIteration(validRange, 8u) ==
                   fuse::physics::broadphase::canSkipCellOccupancyIteration(validRange, 8u),
               "wouldSkipCellOccupancyIteration agrees with canSkipCellOccupancyIteration");
    expectTrue(fuse::physics::broadphase::wouldSkipCellSpanClamp(validRange, 3u) ==
                   fuse::physics::broadphase::canSkipCellSpanClamp(validRange, 3u),
               "wouldSkipCellSpanClamp agrees with canSkipCellSpanClamp");
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferCompaction(buffer) ==
                   fuse::physics::broadphase::canSkipPairBufferCompaction(buffer),
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferClamp(buffer) ==
                   fuse::physics::broadphase::canSkipPairBufferClamp(buffer),
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferDedupe(buffer) ==
                   fuse::physics::broadphase::canSkipPairBufferDedupe(buffer),
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferSort(buffer) ==
                   fuse::physics::broadphase::canSkipPairBufferSort(buffer),
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferCompactAndClamp(buffer) ==
                   fuse::physics::broadphase::canSkipPairBufferCompactAndClamp(buffer),
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferToVector(buffer) ==
                   fuse::physics::broadphase::canSkipPairBufferToVector(buffer),
...
void testPairBufferInvalidateSlotRejectReasonGuards() {
    ...
    expectTrue(fuse::physics::broadphase::canSkipPairBufferInvalidateSlot(buffer, 0u),
               "canSkipPairBufferInvalidateSlot true for already-invalid slot");
    buffer.invalidateSlot(0u);
    expectTrue(!buffer.slotIsValid(0u), "invalidateSlot remains no-op on already-invalid slot via preflight gate");

    fuse::physics::broadphase::PairBufferSoA pushBuffer;
    pushBuffer.push(0u, 1u);
    expectTrue(fuse::physics::broadphase::shouldRunPairBufferInvalidateSlot(pushBuffer, 0u),
               "push-mode buffer accepts invalidate on active slot");
    pushBuffer.invalidateSlot(0u);
    expectTrue(!pushBuffer.slotIsValid(0u), "push-mode invalidateSlot clears valid slot via preflight gate");
}

void testBroadphaseWouldSkipHelpers() {
    fuse::physics::RigidBodySoA bodies;
    fuse::physics::CollisionShapeSoA shapes;
    fuse::physics::broadphase::PairBufferSoA buffer;
    ...
    expectTrue(fuse::physics::broadphase::shouldRunCellSpanClamp(overSpanRange, params.maxCellSpanPerAxis),
...
void testWouldSkipCellCapacityGuards() {
    ...
    buffer.writeSlot(1u, 2u, 3u);
    expectTrue(buffer.slotIsValid(1u), "out-of-range invalidateSlot leaves valid slot intact");
    expectTrue(!buffer.slotIsValid(0u), "repeated invalidateSlot on cleared slot is a no-op");
...
void testPairBufferWriteSlotWouldSkipGuards() {
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferWriteSlot(buffer, 2u, 0u, 1u) ==
                   fuse::physics::broadphase::canSkipPairBufferWriteSlot(buffer, 2u, 0u, 1u),
...
void testRefineDedupeMergePreflightCounts() {
    ...
    expectTrue(preflight.canInvalidate(), "preflight accepts valid slot for invalidate");
    expectTrue(fuse::physics::broadphase::invalidatePairBufferSlotWithPreflight(buffer, 1u),
               "invalidate with preflight runs on valid slot");
    expectTrue(!buffer.slotIsValid(1u), "invalidate with preflight clears slot validity");
    expectTrue(!fuse::physics::broadphase::invalidatePairBufferSlotWithPreflight(buffer, 1u),
               "invalidate with preflight skips already-invalid slot");
...
void testWouldSkipRefineDedupeMergeGuards() {
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipCellSpanClamp(validRange, 4u) ==
                   fuse::physics::broadphase::canSkipCellSpanClamp(validRange, 4u),
    ...
    expectTrue(preflight.outOfRangeSlot, "invalidate preflight marks outOfRangeSlot");
...
void testPairBufferPreflightDeepenGuards() {
    ...
    expectTrue(!buffer.slotIsValid(0u), "out-of-range invalidateSlot is a no-op via preflight gate");
...
void testPairBufferWouldSkipGuards() {
    ...
    fuse::physics::broadphase::PairBufferSoA emptyBuffer;
    ...
    expectEq(static_cast<fuse::u32>(compactionReason),
             static_cast<fuse::u32>(fuse::physics::broadphase::PairBufferCompactionRejectReason::EmptyBuffer),
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipPairBufferCompaction(emptyBuffer) ==
                   fuse::physics::broadphase::canSkipPairBufferCompaction(emptyBuffer),
               "wouldSkipPairBufferCompaction agrees with canSkipPairBufferCompaction");
    ...
    expectEq(static_cast<fuse::u32>(exportReason),
             static_cast<fuse::u32>(fuse::physics::broadphase::PairBufferToVectorRejectReason::EmptyBuffer),
...
void testPairBufferInvalidateSlotRejectReasonGuards() {
    ...
    expectTrue(fuse::physics::broadphase::pairBufferInvalidateSlotRejectsForReason(
                   buffer, 0u,
                   fuse::physics::broadphase::PairBufferInvalidateSlotRejectReason::OutOfRangeSlot),
               "empty buffer rejects invalidate for OutOfRangeSlot");
    ...
    expectTrue(std::strcmp(fuse::physics::broadphase::pairBufferInvalidateSlotRejectReasonName(
               ...
               "AlreadyInvalid invalidate reject reason has stable label");
                 fuse::physics::broadphase::PairBufferInvalidateSlotRejectReason::EmptyBuffer),
               "empty buffer rejects for EmptyBuffer invalidate reason");
               "OutOfRangeSlot invalidate reject reason has stable label");
...
void testCellCapacityWouldSkipGuards() {
    ...
    expectTrue(!buffer.slotIsValid(0u), "invalidateSlot no-op on already-invalid slot via preflight gate");
...
void testPairBufferWriteSlotWouldSkipGuards() {
    ...
    expectTrue(buffer.slotIsValid(0u), "invalidate preflight gate leaves valid slot untouched");
    expectTrue(buffer.slotIsValid(0u), "out-of-range invalidate is a no-op via preflight gate");
...
void testWouldSkipCellCapacityGuards() {
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipCellSpanClamp(spanRange, 4u) ==
                   fuse::physics::broadphase::canSkipCellSpanClamp(spanRange, 4u),
...
void testRefineDedupeMergeWouldSkipGuards() {
    expectTrue(!buffer.slotIsValid(1u), "out-of-range invalidateSlot leaves untouched slot unchanged");
    expectEq(static_cast<fuse::u32>(fuse::physics::broadphase::pairBufferInvalidateSlotRejectReason(buffer, 2u)),
...
void testWouldSkipBroadphaseGuardHelpers() {
    ...
    expectTrue(!buffer.slotIsValid(0u), "invalidateSlot via preflight gate clears valid slot");


    expectTrue(!fuse::physics::broadphase::wouldSkipPairBufferWriteSlot(buffer, 0u, 0u, 1u),

    expectTrue(withinBudget.canInsert(), "cell capacity preflight accepts range within budget");
    expectEq(withinBudget.occupancyCount, 8u, "cell capacity preflight reports occupancy count");
    expectTrue(!fuse::physics::broadphase::wouldSkipShapeCellInsertion(validRange, 8u),
               "wouldSkipShapeCellInsertion false within budget");
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipShapeCellInsertion(validRange, 7u),
               "wouldSkipShapeCellInsertion true over budget");
    expectTrue(fuse::physics::broadphase::wouldSkipShapeCellInsertion(validRange, 7u) ==
                   fuse::physics::broadphase::wouldSkipCellOccupancyIteration(validRange, 7u),
    ...
    fuse::physics::broadphase::CellRange3 inverted = {{2, 2, 2}, {1, 1, 1}};
             ...
             static_cast<fuse::u32>(fuse::physics::broadphase::CellCapacityRejectReason::EmptyRange),
             "inverted range reports EmptyRange cell capacity reject reason");
    expectTrue(fuse::physics::broadphase::cellCapacityRejectsForReason(
...
void testBroadphaseWouldSkipHelpers() {
               "invalidate rejects for AlreadyInvalid after first invalidate");
    expectTrue(!buffer.slotIsValid(0u), "slotIsValid false after invalidate");

                           "OutOfRangeSlot") == 0,

    expectTrue(buffer.slotIsValid(1u) || !buffer.slotIsValid(1u),
               "out-of-range invalidateSlot is a no-op");

    expectTrue(preflight.alreadyInvalid, "invalidate preflight marks alreadyInvalid");
    expectTrue(!preflight.canInvalidate(), "invalidate preflight cannot invalidate already-invalid slot");
    ...
    expectTrue(buffer.slotIsValid(1u), "slot 1 valid before out-of-range invalidate");
    expectTrue(buffer.slotIsValid(1u), "out-of-range invalidateSlot is no-op via preflight gate");
...
void testMergePairIntoBufferPreflightGuards() {
    ...
    const fuse::physics::broadphase::CellRange3 overBudget = {{0, 0, 0}, {3, 3, 3}};
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipCellOccupancyIteration(overBudget, 8u) ==
                   fuse::physics::broadphase::canSkipCellOccupancyIteration(overBudget, 8u),
    expectTrue(!fuse::physics::broadphase::wouldSkipCellSpanClamp(overBudget, 3u),
    expectTrue(fuse::physics::broadphase::wouldSkipCellSpanClamp(overBudget, 3u) ==
                   fuse::physics::broadphase::canSkipCellSpanClamp(overBudget, 3u),
    ...
    const fuse::physics::broadphase::CellRange3 spanRange = {{0, 0, 0}, {10, 0, 0}};
...
void testRefineDedupeMergeWouldSkipGuards() {
    ...
    expectTrue(fuse::physics::broadphase::wouldSkipMergePairsIntoBuffer(mergePairs, buffer) ==
                   fuse::physics::broadphase::canSkipMergePairsIntoBuffer(mergePairs, buffer),
               "wouldSkipMergePairsIntoBuffer agrees with canSkipMergePairsIntoBuffer");
...
void testWouldSkipRefineDedupeMergeGuards() {
    ...
    const std::vector<fuse::physics::broadphase::CandidatePair> pairs = {{4u, 5u}};
...
void testPairBufferWouldSkipHelpers() {
...
int main() {
    ...
    testRefineDedupeMergeWouldSkipHelpers();
    testWouldSkipBroadphaseGuardParity();
    ...
    testPairBufferWriteSlotWouldSkipGuards();
    testPairBufferWouldSkipGuards();
    testWouldSkipBroadphaseGuardHelpers();
    testWouldSkipBroadphaseHelperGuards();
    testBroadphaseWouldSkipHelpers();
    testPairBufferWouldSkipHelpers();
